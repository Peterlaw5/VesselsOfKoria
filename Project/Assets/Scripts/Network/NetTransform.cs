...
namespace Mirror
{
    public class NetTransform : NetBehaviour
    {
        ...
        [Tooltip("Transform to sync")]
        public Transform target;
        Transform targetComponent => target;
        [Tooltip("Bypass interpolation and teleport")]
        ...
        bool NeedsTeleport()
        {
            ...
            return forceTeleport || timeSinceGoalReceived > difference * 5;
        }

        // moved since last time we checked it?
        protected bool HasMovedOrRotated()
        {
            // moved or rotated?
...
namespace VoK
{
    public class PlayerSpawnPoint
    {
        ...
        public PlayerSpawnPoint(Transform tf, Team tm)
        {
            transform = tf;
            team = tm;
        }
